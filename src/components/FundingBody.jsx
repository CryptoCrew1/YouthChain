...
const dropdownButtons = <div className='flex items-center justify-end space-x-5'>
    <Menu as="div" className="inline-block relative">
        <div>
            <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-transparent px-3 py-2 text-sm font-semibold text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-800">
                City
...
const FundingBody = () => {
    return (
        <div className='mx-auto max-w-6xl px-2 sm:px-6 lg:px-8 pt-10'>
            {dropdownButtons}
    ...
    return (
        <div className="overflow-x-hidden scrolling-touch">
            <div className='flex-col'>
                ...
                <div className="flex mt-5 flex-shrink-0 justify-between space-x-5">
